...
import { ShieldCheck, CreditCard, Mail, Truck, Palette, LockKeyhole, Tags } from 'lucide-react';
  ...
  return (
    <div className="space-y-3 rounded-2xl border border-border/70 bg-white p-2">
      ...
      <div className="border-t border-border/70 pt-2">
        ...
        <Link
          to="/admin/gtm-settings"
          className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-muted/40 hover:text-foreground"
        >
          <Tags size={16} />
